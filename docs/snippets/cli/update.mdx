...
<ParamField path="--latest" type="boolean">
  将软件包更新到最新版本。别名: <code>-L</code>
</ParamField>

### 依赖范围

<ParamField path="--dev" type="boolean">
  仅更新 <code>devDependencies</code>。别名: <code>-D</code>
</ParamField>

<ParamField path="--prod" type="boolean">
  仅更新 <code>dependencies</code> 和 <code>optionalDependencies</code>。别名: <code>-P</code>、{" "}
  <code>--production</code>
</ParamField>

<ParamField path="--no-optional" type="boolean">
  不更新 <code>optionalDependencies</code>
</ParamField>
